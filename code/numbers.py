...
digits = "numzero numone numtwo numthree numfour numfive numsix numseven numbereight numnine".split()
teens = "numten eleven twelve thirteen fourteen fifteen sixteen seventeen eighteen nineteen".split()
