...
symbols = [
    ...
    Symbol("[", None,["bracket", "L bracket", "left bracket", "square", "L square", "left square",],),
    Symbol("]", None, ["R bracket", "right bracket", "R square", "right square"]),
